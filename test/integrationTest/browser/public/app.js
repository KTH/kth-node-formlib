...
/***/ function(module, exports, __webpack_require__) {
	...
	var listField = __webpack_require__(2)
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	module.exports.init = function () {
	  ...
	  $(document).on('click', '.IListField-RemoveBtn', doRemoveSelected)
	  $(document).on('click', '.IListField-Row--RemoveCheckbox', onToggleRemoveCheckbox)
	}
	
	module.exports.cleanup = function () {
	  $(document).off('click', '.IListField-AddBtn', doAddRow)
	  $(document).off('click', '.IListField-RemoveBtn', doRemoveSelected)
	  $(document).off('click', '.IListField-Row--RemoveCheckbox', onToggleRemoveCheckbox)
