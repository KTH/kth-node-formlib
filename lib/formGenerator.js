...
renderOptions
  var outp = registry.getAdapter(fieldValidator, safeGet(() => renderOptions.renderWith) || IInputFieldWidget).renderrender(key, data, fieldError, lang, objectNamespace, disabled, submitted, renderOptions)
