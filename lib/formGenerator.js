...
module.exports.renderField = function (options) {
  ...
  const displayOnly = options.displayOnly
  ...
  var outp = registry.getAdapter(fieldValidator, IInputFieldWidget).render(key, data, fieldError, lang, objectNamespace, disabled, submitted, displayOnly)
