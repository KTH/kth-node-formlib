...
module.exports.renderField = function (options) {
  ...
  var outp = registry.getAdapter(fieldValidator, IInputFieldWidget).render(key, data, fieldError, lang, objectNamespace, disabled, submitted)
  outp += '<p class="help-block">' + helpLabel + '</p>'
