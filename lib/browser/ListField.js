...
var updateNames = function (containerEl, dataIdTemplate) {
  ...
  if (theRows.toArray().length > 0) {
    $(containerEl).find('.IListField-ContentPlaceholderRow').addClass('IListField-ContentPlaceholderRowHidden')
  } else {
    $(containerEl).find('.IListField-ContentPlaceholderRow').removeClass('IListField-ContentPlaceholderRowHidden')
  }
