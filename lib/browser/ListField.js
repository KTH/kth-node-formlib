...
var doToggleActionBtns = function (containerEl) {
  ...
  if (nrofItems <= minItems || nrofItems <= 0) {
    ...
    // $containerEl.find('.IListField-AddBtn').animate({ width: '100%', "padding-left": "1.8em", opacity: 1}, {duration: 300, done: function () { $(this).removeClass('ActionBtnHidden') }})
    $containerEl.find('.IListField-AddBtn').removeClass('ActionBtnHidden')
    // $containerEl.find('.IListField-RemoveBtn').animate({ width: 0, "padding-left": 0, opacity: 0}, { duration: 300, done: function () { $(this).addClass('ActionBtnHidden') } })
    ...
    // $containerEl.find('.IListField-RemoveBtn').animate({ width: '100%', "padding-left": "1.8em", opacity: 1}, {duration: 300, done: function () { $(this).removeClass('ActionBtnHidden') }})
    $containerEl.find('.IListField-RemoveBtn').removeClass('ActionBtnHidden')
    // $containerEl.find('.IListField-AddBtn').animate({ width: 0, "padding-left": 0, opacity: 0}, { duration: 300, done: function () { $(this).addClass('ActionBtnHidden') } })
