...
var doAddRow = function (event) {
  ...
  clone.on('toggle', onToggleRemoveCheckbox)
...
module.exports.init = function () {
  ...
  $('.IListField-Row--RemoveCheckbox').on('toggle', onToggleRemoveCheckbox)
}

module.exports.cleanup = function () {
  $('.IListField-AddBtn').off('click', doAddRow)
  $('.IListField-RemoveBtn').off('click', doRemoveSelected)
  $('.IListField-Row--RemoveCheckbox').off('toggle', onToggleRemoveCheckbox)
