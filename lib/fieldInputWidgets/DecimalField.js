...
const IDecimalField = require('isomorphic-schema').interfaces.IDecimalField
...
registry.registerAdapter(DecimalInputAdapter)

var DecimalDisplayAdapter = createAdapter({
...
registry.registerAdapter(DecimalDisplayAdapter)