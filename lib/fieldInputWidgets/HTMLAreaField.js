...
var HTMLAreaInputAdapter = createAdapter({
  ...
  render: function (key, data, fieldError, lang, objectNamespace, disabled, submitted, renderOptions) {
    ...
    if (this.context.readOnly) {
      ...
      outp += '<button tabindex="-1" class="btn btn-xs" style="height: 0; width: 0; border: 0; padding: 0"><i style="visibility: hidden;" class="glyphicon glyphicon-picture txt-color-white"></i></button>'
