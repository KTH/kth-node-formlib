...
const IDateTimeField = require('isomorphic-schema').interfaces.IDateTimeField
...
var DateTimeInputAdapter = createAdapter({
  implements: IInputFieldWidget,
  adapts: IDateTimeField,
...
registry.registerAdapter(DateTimeInputAdapter)

var DateTimeDisplayAdapter = createAdapter({
...
registry.registerAdapter(DateTimeDisplayAdapter)